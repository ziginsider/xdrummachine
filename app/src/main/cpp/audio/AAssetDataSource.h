...
#ifndef ZDRUMMACHINE_AASSETDATASOURCE_H
#define ZDRUMMACHINE_AASSETDATASOURCE_H
...
public:
    ...
    static AAssetDataSource *newFromCompressedAssetZ(
...
#endif //ZDRUMMACHINE_AASSETDATASOURCE_H
